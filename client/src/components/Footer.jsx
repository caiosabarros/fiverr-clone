  ...
  const data = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Selling on Executor", link: "#" },
        { name: "Buying on Executor", link: "#" },
      ],
    },
    {
    ...
    {
      headerName: "Move From Executor",
      links: [
        { name: "Executor Business", link: "#" },
        { name: "Executor Pro", link: "#" },
        { name: "Executor Logo Maker", link: "#" },
        { name: "Executor Guides", link: "#" },
        { name: "Get Inspired", link: "#" },
        { name: "Executor Select", link: "#" },
        { name: "ClearVoice", link: "#" },
        { name: "Executor Workspace", link: "#" },
        { name: "Learn", link: "#" },
